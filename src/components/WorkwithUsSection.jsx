...
() {
  return (
    <div className='h-screen bg-blue-100 w-[96%] m-auto rounded-3xl pt-[4%] pl-[3%]'>
      <div className='flex justify-between w-[95%] mb-5'>
        <h1 className='text-gray-800 text-3xl font-bold'>Work with us</h1>
        <h1 className='text-blue-600 text-4xl font-Roboto font-medium'>ahead</h1>
      </div>
      <div className='mr-[4%] flex justify-around'>
      <div className='bg-white rounded-2xl mr-[20%] shadow-2xl h-[400px]'>
        <div className='mt-5 ml-5'>
          <FaSnapchatGhost size={40} color='lightblue'   />
      ...
      <div className='overflow-y-scroll scrollbar-track scrollbar-thumb rounded-md h-[550px]'>
